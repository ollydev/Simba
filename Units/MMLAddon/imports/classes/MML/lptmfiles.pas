...
procedure TMFiles_OpenFile(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TMFiles_RewriteFile(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PMFiles(Params^[0])^.RewriteFile(PlpString(Params^[1])^, PBoolean(Params^[2])^);
end;

//function AppendFile(Path: string): Integer;
procedure TMFiles_AppendFile(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PMFiles(Params^[0])^.AppendFile(PlpString(Params^[1])^);
end;

//function DeleteFile(Filename: string): Boolean;
procedure TMFiles_DeleteFile(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PMFiles(Params^[0])^.DeleteFile(PlpString(Params^[1])^);
end;

//function RenameFile(OldName, NewName: string): Boolean;
procedure TMFiles_RenameFile(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PMFiles(Params^[0])^.RenameFile(PlpString(Params^[1])^, PlpString(Params^[2])^);
end;

//procedure CloseFile(FileNum: Integer);
procedure TMFiles_CloseFile(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMFiles(Params^[0])^.CloseFile(PInteger(Params^[1])^);
end;

//procedure WriteINI(const Section, KeyName, NewString : string; FileName : string);
procedure TMFiles_WriteINI(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TMFiles_ReadINI(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TMFiles_DeleteINI(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMFiles(Params^[0])^.DeleteINI(PlpString(Params^[1])^, PlpString(Params^[2])^, PlpString(Params^[3])^);
end;

//function EndOfFile(FileNum: Integer): Boolean;
procedure TMFiles_EndOfFile(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PBoolean(Result)^ := PMFiles(Params^[0])^.EndOfFile(PInteger(Params^[1])^);
end;

//function FileSizeMuf(FileNum: Integer): LongInt;
procedure TMFiles_FileSizeMuf(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TMFiles_ReadFileString(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TMFiles_SetFileCharPointer(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
...
procedure TMFiles_FilePointerPos(const Params: PParamArray; const Result: Pointer); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PInteger(Result)^ := PMFiles(Params^[0])^.FilePointerPos(PInteger(Params^[1])^);
end;

//constructor Create(Owner : TObject);
procedure TMFiles_Init(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
  PMFiles(Params^[0])^ := TMFiles.Create(PObject(Params^[1])^);
end;

//procedure Free();
procedure TMFiles_Free(const Params: PParamArray); {$IFDEF Lape_CDECL}cdecl;{$ENDIF}
begin
